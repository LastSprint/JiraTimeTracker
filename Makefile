...
synx:
	bundle exec synx --exclusion "JiraTimeTracker/Non-iOS Resources" JiraTimeTracker.xcodeproj
...
targets_check:
	bundle exec ruby ./scripts/sourcesComparing.rb  "./JiraTimeTracker.xcodeproj" "JiraTimeTrackerRelease" "JiraTimeTrackerDebug"
